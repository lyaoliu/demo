...
public class DialectUtil {
     ...
     * @return
     */
    public static String getMysqlCountString(String querySelect) {
    ...
    public static String getOracleCountString(String querySelect) {
         StringBuffer buffer=new StringBuffer("select count(1) as count from (");
         buffer.append(querySelect).append(" )");
